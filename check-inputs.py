...
try_plot_test = True # use if you want to try plotting also the actual execution of the test
...
if try_plot_test and exists(directory+file_name) :
    ...
    test_results.positionSpeedPlot()
    test_results.z_loop_frequency_plot()
